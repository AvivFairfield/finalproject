...
import { MoodData } from '../utils/csvParser';
    ...
    const chartData: ChartData[] = Object.keys(groupedData)
      ...
      .map(timeKey => {
        ...
        return {
          ...
          'Physical Difficulty': timeData['Physical Difficulty']?.severity || null,
          "Parkinson's State": timeData["Parkinson's State"]?.severity || null,
      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
          ...
          <YAxis 
            ...
            fontSize={12}
            tick={{ fill: '#666' }}
            label={{ value: 'Severity (1-5)', angle: -90, position: 'insideLeft' }}
          />
